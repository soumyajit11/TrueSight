...
const Welcome = () => {
    ...
    return (
        <div className='text-white'>
            {/* Section that uses the hidden class */}
            <div className='intro1 h-[100vh] flex justify-center flex-col pl-40 pr-40 pt-5'>
                ...
                <NavLink className={(e)=>{return e.isActive?"red": "" }} to="/upload">
            ...
            {/* Sections that will animate into view */}
            <div className="intro2 pt-60 ">
                <div className="img flex justify-center items-center gap-4 ">
                    <img className='h-[200px] rounded-2xl' src='i01.webp' alt="" />
                    <img className='h-[200px] rounded-2xl' src='i02.webp' alt="" />
                    <img className='h-[200px] rounded-2xl' src='i03.webp' alt="" />
                    <img className='h-[200px] rounded-2xl' src='i04.webp' alt="" />
                </div>
            </div>
            ...
            <div className='intro3 h-[100vh] flex flex-col gap-2 justify-between items-center pt-[90vh]'>
                <div className='px-20 pt-20 text-center'>
                    <p className='text-5xl'>Generative AI Architecture</p>
                    <p className="text-3xl">Whether you're building your own models or applying foundation models to your business, data remains the biggest setback to AI.</p>
                </div>
